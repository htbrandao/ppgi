...
- Precisa ser reescrito. Não foi possível identificar o objetivo, como foi feito e o que os resultados alcançaram.
    ...
    1) qual a problemática a ser investigada e o gap de pesquisa a ser sanado
    2) o que está sendo proposto
    3) qual o mérito da proposta
    4) qual(is) a(s) contribuição(ões) do trabalho
    5) como a proposta foi avaliada/validada.
...
- Todas as figuras devem estar em português.
...
- Mesmo comentário da revisão anterior: "Verifique se todas as figuras estão devidamente mencionadas no texto."

- A maneira como tá o footnote não é adequada.
