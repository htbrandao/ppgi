...
%         ~\cite{32.32} & x & ~ & x & ~ & ~ \\ \hline
%         ~\cite{11} & x & ~ & ~ & ~ & ~ \\ \hline
%         ~\cite{32.31} & x & ~ & x & ~ & ~ \\ \hline
%         ~\cite{32.25} & x & ~ & x & ~ & ~ \\ \hline
%         ~\cite{34} & x & x & x & ~ & ~ \\ \hline
%         ~\cite{32.95} & x & ~ & x & ~ & ~ \\ \hline
%         ~\cite{12} & x & ~ & x & ~ & ~ \\ \hline
%         ~\cite{21} & x & ~ & x & ~ & x \\ \hline
%         ~\cite{pca6} & x & ~ & x & ~ & ~ \\ \hline
%         Dissertação & x & x & ~ & x & x \\ \hline
%     \end{tabular}\label{table:discussao}
% \end{table}
...
%     \hline
%     Trabalho        & Cromática & Espectral & Prosódica & Superv.   & Não superv.   & ML    & DL    & Português     & Emoção    & Intensidade   \\ \hline
%     \cite{32.32}    &  ~        &           & x         & x         &  ~            & x     & ~     & ~             & x     	& ~             \\ \hline
...
%     Dissertação     & x         & x         & x         & x         & x             & x     & x     & x             & ~         & x             \\ \hline
%     \end{tabular}\label{table:discussao}
% \end{table}
...
%     \hline
%     \textbf{Trabalho} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{\textit{Features}\\Cromáticas}}}\end{tabular} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{\textit{Features}\\Espectrais}}}\end{tabular} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{\textit{Features}\\Prosódicas}}}\end{tabular} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{Aprendizagem\\Supervisionada}}}\end{tabular} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.8cm}{Aprendizagem\\Não Supervisionada}}}\end{tabular} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{\textit{Machine\\Learning}}}}\end{tabular} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{\textit{Deep Learning}}}}\end{tabular} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{Português}}}\end{tabular} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{Emoção}}}\end{tabular} &
%     \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{Intensidade}}}\end{tabular} \\ \hline
%     % Trabalho        & Cromática & Espectral & Prosódica & Superv.   & Não superv.   & ML    & DL    & Português     & Emoção    & Intensidade   \\ \hline
%     \cite{32.32}    &  ~        &           & x         & x         &  ~            & x     & ~     & ~             & x     	& ~             \\ \hline
%     \cite{11}       &  ~        & x         & x         & x         &  ~            & x     & x     & ~             & ~         & ~             \\ \hline
%     \cite{32.31}    & x         & x         & x         & x         &  ~            & ~     & x     & ~             & x         & ~             \\ \hline
...
\begin{table}[]
    ...
    \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{Emoção}}}\end{tabular} &
    \begin{tabular}[c]{@{}c@{}}{\rotatebox{90}{\parbox{3.5cm}{Intensidade}}}\end{tabular} \\ \hline
    % Trabalho     & Superv.   & Não superv.   & ML    & DL    & Português     & Emoção    & Intensidade    \\ \hline
    \cite{32.32}   & x         &  ~            & x     & ~     & ~             & x     	& ~                 \\ \hline
    \cite{11}      & x         &  ~            & x     & x     & ~             & ~         & ~              \\ \hline
    \cite{32.31}   & x         &  ~            & ~     & x     & ~             & x         & ~              \\ \hline
    \cite{32.25}   & x         &  ~            & x     & ~     & ~             & x         & ~              \\ \hline
    \cite{34}      & x         & x             & ~     & x     & ~             & x         & ~              \\ \hline
