...
\begin{figure}%[h]
    \centering
    \includegraphics[angle=90, width=0.8\textwidth]{img/pca128-re.png}
    \caption{\label{fig:pca128}\acrshort{PCA} com 2 componentes aplicado ao resultado do \textit{encoding} do segundo experimento}
\end{figure}

\begin{figure}%[h]
    \centering
    \includegraphics[angle=90, width=0.8\textwidth]{img/pca128-2-re.png}
