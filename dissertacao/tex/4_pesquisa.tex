...
Até o momento da escrita deste trabalho, não conhecemos algum \textit{dataset} que seja ideal (idioma, emoções e intensidade) para esta proposta. Então, conforme descrito no Capítulo 2, este trabalho utilizará duas bases de dados: VERBO~\cite{12.21} e VIVAE~\cite{16}.
...
\begin{figure}[]
    \centering
    \includegraphics[width=0.6\textwidth]{img/p-autoencoder.png}
