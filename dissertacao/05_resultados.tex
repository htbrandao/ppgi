...
Definida a arquitetura composta por um Autoencoder (\ref{sec:bravo_ae}) e uma Rede Neural (\ref{sec:bravo_clf}), tomamos apenas as emoções comuns (\ref{sec:bravo_dados}) entre as duas bases de dados (alegria, medo, raiva e surpresa), totalizando 1364 registros, onde 51\% apresentam a o \textit{label} relativo a intensidade. %A Figura \ref{fig:design} apresenta o \textit{design} do \textit{BRAVO}.

% \begin{figure}[h]
%     \centering
%     \includegraphics[width=1.0\textwidth]{imagens/design.PNG}
...
\begin{figure}[h]
    ...
    \begin{minipage}[b]{0.4\linewidth}
        \centering
        \includegraphics[width=\linewidth]{imagens/ae64.png}
        \caption{\label{fig:ae64}Arquitetura do Autoencoder para 64 \textit{MFCCS}}
    \end{minipage}
    % \hfill
    \begin{minipage}[b]{0.4\linewidth}
        \centering
        \includegraphics[width=\linewidth]{imagens/ae128.png}
...
\begin{figure}[h]
    ...
    \begin{minipage}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{imagens/clf64.png}
        \caption{\label{fig:clf64}Arquitetura do classificador do experimento com 64 \textit{MFCCs}}
    \end{minipage}
    % \hfill
    \begin{minipage}[b]{0.45\linewidth}
    \centering
        \includegraphics[width=\linewidth]{imagens/clf128.png}
...
\input{05A_resultado_64}
\input{05B_resultado_128}
