...
Definida a arquitetura composta por um \acrlong{AE}Autoencoder e um Classificador, tomamos apenas as emoções comuns entre as duas bases de dados (alegria, medo, raiva e surpresa), totalizando 1364 registros, onde 51\% apresentam a o \textit{label} relativo a intensidade. %A Figura \ref{fig:design} apresenta o \textit{design} do \textit{BRAVO}.
...
Dadas as Figuras \ref{fig:pca64} e \ref{fig:pca128}, conseguimos observar que as classes Fraca e Pico ocupam os extremos dos \textit{clusters}, o que pode tornar sua separação mais fácil frente às amostras das classes Moderada e Forte, as quais podemos notar mais amalgamadas na região central. Esta distruição parece estar de acordo com nossos resultados, uma vez que os dois melhores desempenhos - em ambos os cenários - foram das classes Fraca e Pico, e os piores das classes Moderada e Forte.
